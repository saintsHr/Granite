...
CFLAGS   := -Wall -Wextra -DGLFW_INCLUDE_NONE -DSTB_IMAGE_IMPLEMENTATION $(INCLUDE) $(DEPFLAGS)
CXXFLAGS := -Wall -Wextra -DGLFW_INCLUDE_NONE -DSTB_IMAGE_IMPLEMENTATION $(INCLUDE) $(DEPFLAGS)
